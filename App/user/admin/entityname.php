...
$sql = "SELECT * FROM entityname_list ORDER BY id DESC";
...
$sql = "SELECT  entityname FROM entityname_list";
$result = $conn->query($sql);
...
$sql = "INSERT INTO entityname_list (entityname)
  VALUES ('$name')";
...
$sql = "UPDATE entityname_list SET entityname='$nname' WHERE entityname='$name'";
...
$sql = "DELETE FROM entityname_list  WHERE entityname='$name'";
